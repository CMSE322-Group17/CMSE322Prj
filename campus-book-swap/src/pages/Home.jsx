...
const Home = () => {
  ...
  }, [loading.popular, error.popular, popularBooks, handleSelectBook]);
  ...
  // Prepare favorite books for display if authenticated
  const favoriteBooksList = useMemo(() => {
    // This ensures we're not returning the same object reference as booksOfWeek,
    // which could cause unnecessary re-renders
    return isAuthenticated ? featuredBooks.slice(0, 5) : [];
  }, [featuredBooks, isAuthenticated]);
