      ...
      >
        ...
        <div className="flex flex-col md:flex-row overflow-hidden">
          ...
          <div className="w-full md:w-1/3 border-r border-gray-200 p-6 overflow-y-auto overscroll-contain touch-pan-y">
            <div className="overflow-x-auto touch-pan-x overscroll-contain pb-2">
              <div className="min-w-max md:min-w-0 md:w-full flex justify-center">
            ...
            <div className="flex justify-center items-center mb-4 overflow-x-auto touch-pan-x">
            ...
            <div className="border-t border-gray-200 pt-4 mt-4">
              ...
              <div className="space-y-2 overflow-x-auto touch-pan-x pb-2">
                <div className="min-w-max md:min-w-0 md:w-full">
                  ...
                  <button 
                    ...
                    className="w-full py-2 px-4 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-colors mt-2"
                  >
                    {actions[book.bookType].secondary}
                  </button>
                  <button 
                    onClick={() => navigate(`/chat/${seller.id}/${book.id}`)}
                    className="w-full py-2 px-4 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 mt-2"
                  >
          ...
          <div className="w-full md:w-2/3 p-6 overflow-y-auto overscroll-contain touch-pan-y">
            ...
            {activeTab === 'details' && (
              <div>
                <div className="pb-4 overflow-x-auto touch-pan-x overscroll-contain">
                  <div className="min-w-max md:min-w-0 md:w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-medium text-gray-800 mb-3">Book Information</h4>
                      <div className="space-y-2 text-sm">
                        <p className="flex justify-between w-full">
                          <span className="font-medium text-gray-700 mr-2">Course:</span> 
                        ...
                        {book.bookType === 'For Swap' && (
                          <p className="flex justify-between w-full">
                            <span className="font-medium text-gray-700 mr-2">Exchange For:</span> 
                        ...
                        {book.bookType === 'For Borrowing' && (
                          <>
                            ...
                            <p className="flex justify-between w-full">
                              <span className="font-medium text-gray-700 mr-2">Deposit:</span> 
                              <span className="text-gray-600">{borrowingDetails.deposit}</span>
                            </p>
                            <p className="flex justify-between w-full">
                              <span className="font-medium text-gray-700 mr-2">Available From:</span> 
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <p className="flex justify-between w-full">
                          <span className="font-medium text-gray-700 mr-2">Pick-up Location:</span> 
                          <span className="text-gray-600">{seller.location}</span>
                        </p>
                        <p className="flex justify-between w-full">
                          <span className="font-medium text-gray-700 mr-2">Payment Methods:</span> 
                          <span className="text-gray-600">Cash, Venmo, PayPal</span>
                        </p>
                        <p className="flex justify-between w-full">
                          <span className="font-medium text-gray-700 mr-2">Listed On:</span> 
                ...
                {/* Additional book details like ISBN, publisher, etc */}
                                  <div className="mt-6 text-sm text-gray-500 overflow-x-auto touch-pan-x pb-2">
            ...
            {activeTab === 'seller' && (
              <div>
                ...
                <div className="overflow-x-auto touch-pan-x overscroll-contain pb-4">
                  <div className="min-w-max md:min-w-0 md:w-full grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="mt-6">
                  ...
                  <div className="overflow-x-auto touch-pan-x overscroll-contain pb-4">
                    <div className="min-w-max md:min-w-0 md:w-full grid grid-cols-2 md:grid-cols-3 gap-4">
                      {/* Sample other books */}
                      {[1, 2, 3].map(i => (
