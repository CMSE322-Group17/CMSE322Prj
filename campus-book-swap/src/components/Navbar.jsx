...
import { useMessage } from "../contexts/MessageContext"; // Import the message context
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            {isAuthenticated && (
              <Link
                to="/messages"
                className="relative ml-4 p-2 text-gray-600 hover:text-blue-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center">
                <Link
                  to="/signin"
                  className="ml-4 px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600"
                >
                  Sign In
                </Link>
                <Link
